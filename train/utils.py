...
def init(library, GPU = False, GPU_ID = -1):
    ...
    if LIB == Lib_supported.TF:
        ...
        return GraphSAGE_pytorch, RandomPytorchSupervisedGraphSage, PrioritizedPytorchSupervisedGraphSage, NoRehPytorchSupervisedGraphSage, FullPytorchSupervisedGraphSage, KcorePytorchSupervisedGraphSage, torch.nn.functional.relu
